...
int main() {
  forma_compleja num_1;
  forma_compleja num_2;
  cout <<"Ingrese la parte real del primer numero complejo: "<<endl;
  cin >> num_1.real;

  cout <<"Ingrese la parte imaginaria del primer numero complejo (no incluir la i): "<<endl;
  cin >> num_1.imaginario;

  cout <<"Ingrese la parte real del segundo numero complejo: "<<endl;
  cin >> num_2.real;

  cout <<"Ingrese la parte imaginaria del segundo numero complejo (no incluir la i): "<<endl;
  cin >> num_2.imaginario;

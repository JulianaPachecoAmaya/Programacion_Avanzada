...
public class Pasajero {
  ...
  public Pasajero(String nombres, String apellidos, String numPasaporte, String asiento, int edad)
    ...
    if (nombres == null || nombres.isEmpty() || apellidos == null || apellidos.isEmpty() || numPasaporte == null
        || numPasaporte.isEmpty() || asiento == null || asiento.isEmpty() || edad < 0) {
  ...
  // Metodo estatico que compara la edad de pasajeros
  public static Pasajero compararEdad(Pasajero pasajero1, Pasajero pasajero2) {
